...
print(
    "Preprocessing Step 1: Deleted rows containing missing values in RainTomorrow, Rainfall and RainToday columns."
)
...
print(
    "Preprocessing Step 2: Deleted columns: Evaporation, Sunshine, Cloud9am, Cloud3pm as they contain more than 30% of missing data."
)
...
print(
    "Preprocessing Step 5: Generated train/test split (80%, 20%): X_train, X_test, y_train, y_test with X being columns and y being target."
)
...
print(
    "Preprocessing Step 7: One-Hot Encoding for categorical columns: Location, WindGustDir, WindDir9am, WindDir3pm, Season"
)
